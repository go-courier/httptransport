...
type FormMultipartWithFile struct {
	FormData struct {
		...
		Map   map[GithubComGoCourierHttptransportTestdataServerPkgTypesProtocol]int32 `name:"map,omitempty"`
...
type GetByID struct {
	...
	Protocol GithubComGoCourierHttptransportTestdataServerPkgTypesProtocol `in:"query" name:"protocol,omitempty"`
}
...
type HealthCheck struct {
	PullPolicy GithubComGoCourierHttptransportTestdataServerPkgTypesPullPolicy `in:"query" name:"pullPolicy,omitempty"`
}
